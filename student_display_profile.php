...
$value = $_GET['email_fetch'];
$load = "SELECT * FROM student_data WHERE emailId='".$value."';";
$load_query = mysqli_query($connect,$load);
$load_fetch = mysqli_fetch_assoc($load_query);
error_reporting(0);
?>
<html>
    <head>
...
<div id="header">
        ...
        <div class="body_header">
            <div class="body_header_container">
                ...
                <a href="disp_teacher_student.php"><div class="tab_s">Student</div></a>

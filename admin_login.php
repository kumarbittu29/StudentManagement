...
if(isset($_POST['submit']))
{
    $login = $_POST['email'];
    $pass = $_POST['pass'];
    $admin_check = "SELECT * FROM admin WHERE loginId='$login' && pass='$pass'";
    $admin_login= mysqli_query($connect,$admin_check);
    $admin_total = mysqli_num_rows($admin_login);
    if($admin_total==1)
        {
        $_SESSION['admin_name']=$login;
         header('location:admin.php', false, 303);
         exit();
        }
    else
        {
        ...
        <div class="body_main">
            <div class="box">
                ...
                <div class="box_container">
                    ...
                    <p class="tnc">Only accessible to ADMIN</p>
                    <p class="alert">
                        <?php
                            echo $error;
                        ?>

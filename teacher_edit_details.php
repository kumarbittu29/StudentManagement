...
<div id="header">
                    ...
                    <table align="center">
                        ...
                        <tr>
                            ...
                            <td colspan="10"><input type="text" name="personaladdress" size="100%" 
                                       ...
                                       <?php
                                            echo 'value="'.$tresult['t_personaladdress'].'"';
                                       ?>
                        ...
                        <tr>
                         ...
                         <tr>
                            ...
                            <td><select name="state">
                                ...
                                echo "<option class=\"select-hr\" selected>".$tresult['t_state']."</option>";
                        ...
                        <tr>
                            ...
                            <td><input type="number" length="10" name="mobileno" class="textbox" 
                                       ...
                                       <?php
                                            echo 'value="'.$tresult['t_mobile_no'].'"';
                                       ?>
        ...
        if($_POST['update']){
            if($name!="" && $fname!="" && $paddress!="" && $personaladdress!="" && $sex!="" && $city!="" && $district!="" && $state!="" && $pincode!="" && $dob!="" && $mno!=""){
                $update = "UPDATE teacher_data SET t_name='".$name."', t_fname='".$fname."', t_paddress='".$paddress."', t_personaladdress='".$personaladdress."', t_sex='".$sex."', t_city='".$city."', t_district='".$district."', t_state='".$state."', t_pincode='".$pincode."', t_dob='".$dob."', t_mobile_no='".$mno."' WHERE t_email='".$username."';";
                //echo $update;
                
                $tresult_update = mysqli_query($connect,$update);
                echo $tresult_update;
                ...
                if($tresult_update){
                   ...
                   echo "<center><font face=\"calibri\" size=\"2px\" color=\"red\">Data updated. Redirecting in 3 sec... <a href=\"teacher_login.php\">Redirect now</a></font></center>";
                    header("refresh:3; url=disp_teacher_profile.php");
                }
                else{

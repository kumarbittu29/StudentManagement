    ...
    <body>
        ...
        <div class="body_header">
            <div class="body_header_container">
                ...
                <a href="#"><div class="tab_s">Student</div></a>
                            ...
                            if($_GET['submit']){
                                ...
                                if($total_name!==0){
                                    ...
                                    {   
                                        ...
                                        echo "<tr class='select'><td>".$a."</td>";
                                        echo "<td><a href=\"student_display_profile.php?email_fetch=".$stu_name['emailId']."\">".$stu_name['name']."</a></td>";
                                        echo "<td>".$stu_name['emailId']."</td>";
                                        echo "<td>".$stu_name['branch']."</td>";
                                        echo "<td>".$stu_name['section']."</td>";
                                        echo "<td>".$stu_name['paddress']."</td>";
                                        echo "<td>".$stu_name['mno']."</td>";
